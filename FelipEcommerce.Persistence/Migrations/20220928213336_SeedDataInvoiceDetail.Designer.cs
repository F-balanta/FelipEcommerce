...
namespace FelipEcommerce.Persistence.Migrations
{
    ...
    [Migration("20220928213336_SeedDataInvoiceDetail")]
    partial class SeedDataInvoiceDetail
    {
            ...
            modelBuilder.Entity("FelipEcommerce.Domain.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            Discount = 19,
                            InvoiceDate = new DateTime(2022, 9, 28, 16, 33, 36, 458, DateTimeKind.Local).AddTicks(4513),
                            Isv = 0,
                            SubTotal = 1000m,
                            Total = 10000m,
                            UserId = 1
