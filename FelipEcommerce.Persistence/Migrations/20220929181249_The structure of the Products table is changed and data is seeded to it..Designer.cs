...
namespace FelipEcommerce.Persistence.Migrations
{
    ...
    [Migration("20220929181249_The structure of the Products table is changed and data is seeded to it.")]
    partial class ThestructureoftheProductstableischangedanddataisseededtoit
    {
